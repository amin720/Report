	...
	class InlineProvide
	{
		...
		public IPdfReportData CreatePdfReport(DbContext modelDbContext = null, string sqlQuery = null, bool tempraryStatus = false)
		{
			return new PdfReport().DocumentPreferences(doc =>
				...
				.Generate(data => data.AsPdfFile(string.Format("{0}\\Pdf\\InlineProvidersPdfReport-{1}.pdf", Reportig.AppPath.ApplicationPath, Guid.NewGuid().ToString("N"))), debugMode: true);
		}
